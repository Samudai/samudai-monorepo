...
const bootStrap = async () => {
    ...
    const seed = new Uint8Array([
        173, 225, 253, 169, 141, 67, 152, 38, 76, 148, 48, 93, 9, 65, 178, 154, 130, 248, 170, 6,
        41, 173, 167, 132, 244, 158, 195, 64, 38, 192, 236, 171,
    ]);
                                            ...
                                            credentialSubject: {
                                                ...
                                                properties: {
                                                    task: {
                                                        ...
                                                        title: 'Task',
                                                        description:
                                                            'The task the credential is for',
                                                    },
                                                    project: {
                                                        type: 'string',
                                                        title: 'Project',
                                                        description:
                                                            'The project the credential is for',
                                                    },
                                                    bounty: {
                                                        type: 'string',
                                                        title: 'Bounty',
                                                        description:
                                                            'The bounty the credential is for',
                                                    },
                                                    Clan: {
                                                        type: 'string',
                                                        title: 'Clan',
                                                        description:
                                                            'The clan the credential is for',
                                                    },
                                                    skill: {
                                                        type: 'array',
                                                        items: {
