...
import (
	...
	analyticssvc "github.com/Samudai/backend/services/analytics"
	...
	externalsvc "github.com/Samudai/backend/services/external"
...
func newEngine() *gin.Engine {
	...
	analyticssvc.Register(engine.Group("/analytics"))
	externalsvc.Register(engine.Group("/external"))
