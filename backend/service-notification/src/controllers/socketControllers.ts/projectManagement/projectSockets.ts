...
export class ProjectSockets {
    ...
    projectNotifications = (io: any, socket: any, redisFunc : any) => {
        ...
        socket.on('added_to_task', async (notificationPartialData: NotificationPartialData) => {
            //Generate the notification
            const taskNotification: WebNotification | null = await projectNotificationTemplateHandler.addedToTaskNotification(
        ...
        socket.on('task_review', async (notificationPartialData: NotificationPartialData) => {
            ...
            const reviewNotification: WebNotification | null = await projectNotificationTemplateHandler.taskReviewNotification(
              notificationPartialData
            );
        ...
        socket.on('task_status_changed', async (notificationPartialData: NotificationPartialData) => {
          ...
          const statusChangedNotification: WebNotification | null = await projectNotificationTemplateHandler.taskStatusChangedNotification(
            notificationPartialData
          )
        ...
        socket.on('task_created', async (notificationPartialData: NotificationPartialData) => {
          ...
          const taskCreatedNotification: WebNotification | null = await projectNotificationTemplateHandler.taskCreatedNotification(
            notificationPartialData
          )
        ...
        socket.on('task_deleted', async (notificationPartialData: NotificationPartialData) => {
          ...
          const taskDeletedNotification: WebNotification | null = await projectNotificationTemplateHandler.taskDeletedNotification(
            notificationPartialData
          )
        ...
        socket.on('task_posted_as_job_or_bounty', async (notificationPartialData: NotificationPartialData) => {
          ...
          const taskPostedAsJobOrBountyNotification: WebNotification | null = await projectNotificationTemplateHandler.taskPostedAsJobOrBountyNotification(
            notificationPartialData
          )
        ...
        socket.on('payout_assigned_contributor', async (notificationPartialData: NotificationPartialData) => {
          ...
          const PayoutAssignedContributorNotification: WebNotification | null = await projectNotificationTemplateHandler.PayoutAssignedContributorNotification(
            notificationPartialData
          )
        ...
        socket.on('payout_assigned_dao', async (notificationPartialData: NotificationPartialData) => {
          ...
          const PayoutAssignedDAONotification: WebNotification | null = await projectNotificationTemplateHandler.PayoutAssignedDAONotification(
            notificationPartialData
          )
        ...
        socket.on('kanban_board_changes', async (notificationPartialData: NotificationPartialData) => {
          ...
          const PayoutAssignedDAONotification: WebNotification | null = await projectNotificationTemplateHandler.KanbanBoardChangedNotification(
            notificationPartialData
          )
        ...
        socket.on('task_status_to_completed', async (notificationPartialData: NotificationPartialData) => {
          ...
          const TaskStatusChangedToCompletedNotification: WebNotification | null = await projectNotificationTemplateHandler.TaskStatusChangedToCompletedNotification(
            notificationPartialData
          )
        ...
        socket.on('comment_on_task_notification', async (notificationPartialData: NotificationPartialData) => {
          ...
          const CommentOnTaskNotification: WebNotification | null = await projectNotificationTemplateHandler.CommentOnTaskNotification(
            notificationPartialData
          )
        ...
        socket.on('attachment_added_to_task', async (notificationPartialData: NotificationPartialData) => {
          ...
          const AttachmentAddedToTask: WebNotification | null = await projectNotificationTemplateHandler.AttachmentAddedToTask(
            notificationPartialData
          )
        ...
        socket.on('task_assigned_to_contributor', async (notificationPartialData: NotificationPartialData) => {
          ...
          const TaskAssignedToContributorNotification: WebNotification | null = await projectNotificationTemplateHandler.TaskAssignedToContributorNotification(
            notificationPartialData
          )
        ...
        socket.on('contributor_removed_from_task_contributor', async (notificationPartialData: NotificationPartialData) => {
          ...
          const ContributorRemovedFromTaskContributorNotification: WebNotification | null = await projectNotificationTemplateHandler.ContributorRemovedFromTaskContributorNotification(
            notificationPartialData
          )
        ...
        socket.on('contributor_removed_from_task_dao', async (notificationPartialData: NotificationPartialData) => {
          ...
          const ContributorRemovedFromTaskDAONotification: WebNotification | null = await projectNotificationTemplateHandler.ContributorRemovedFromTaskDAONotification(
            notificationPartialData
          )
        ...
        socket.on('edit_in_task', async (notificationPartialData: NotificationPartialData) => {
          ...
          const EditInTaskNotification: WebNotification | null = await projectNotificationTemplateHandler.EditInTaskNotification(
            notificationPartialData
          )
        ...
        socket.on('review_nudge_contributor', async (notificationPartialData: NotificationPartialData) => {
          ...
          const ReviewNudgeContributorNotification: WebNotification | null = await projectNotificationTemplateHandler.ReviewNudgeContributorNotification(
            notificationPartialData
          )
        ...
        socket.on('review_nudge_dao', async (notificationPartialData: NotificationPartialData) => {
          ...
          const ReviewNudgeDAONotification: WebNotification | null = await projectNotificationTemplateHandler.ReviewNudgeDAONotification(
            notificationPartialData
          )
