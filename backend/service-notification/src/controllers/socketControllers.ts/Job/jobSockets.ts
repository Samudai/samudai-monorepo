...
export class JobSockets {
    jobNotifications = (io: any, socket: any, redisFunc : any) => {
        ...
        socket.on('job_posted_notification', async (notificationPartialData: NotificationPartialData) => {
          ...
          const reviewNotification: WebNotification | null = await jobNotificationTemplateHandler.postingJob(
        ...
        socket.on('bounty_posted_notification', async (notificationPartialData: NotificationPartialData) => {
          //Generate the notification
          const reviewNotification: WebNotification | null = await jobNotificationTemplateHandler.postingBounty(
            notificationPartialData
          );
        ...
        socket.on('job_applicant_submitted', async (notificationPartialData: NotificationPartialData) => {
            //Generate the notification
            const reviewNotification: WebNotification | null = await jobNotificationTemplateHandler.jobApplicantNotification(
              notificationPartialData
            );
        ...
        socket.on('job_applicant_accepted', async (notificationPartialData: NotificationPartialData) => {
          //Generate the notification
          const reviewNotification: WebNotification | null = await jobNotificationTemplateHandler.accecptanceOfJobApplicantNotification(
            notificationPartialData
          );
        ...
        socket.on('job_applicant_rejected', async (notificationPartialData: NotificationPartialData) => {
          //Generate the notification
          const reviewNotification: WebNotification | null = await jobNotificationTemplateHandler.rejectingJobApplicantNotification(
            notificationPartialData
          );
