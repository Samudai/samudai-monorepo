...
export class Routes {
  ...
  web3Routers = () => {
    ...
    this.router.post(
      "/tokengating/add",
      this.tokenGatingController.addTokenGating,
    );
    this.router.get(
      "/tokengating/get/:daoId",
      this.tokenGatingController.getTokenGating,
    );
    this.router.delete(
      "/tokengating/delete/:daoId",
    ...
    this.router.get(
      "/payment/get/:daoId",
      this.paymentController.getPlatformPaymentsForDAO,
    );
    this.router.get(
      "/payment/get/member/:memberId",
      this.paymentController.getPlatformPaymentsByReceiver,
    );
    this.router.get(
      "/payment/get/task/:taskId",
      this.paymentController.getPlatformPaymentsByTaskId,
    );
    this.router.get(
