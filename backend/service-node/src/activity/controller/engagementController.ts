...
export class EngagementController {
  ...
  addMostActive = async (req: Request, res: Response) => {
    try {
      ...
      res
        .status(201)
        .json({ message: "MostActive added successfully", data: result });
    } catch (err: any) {
      if (err.response) {
        return res.status(err.response.status).send({
          message: "Could not add MostActive",
          error: err.response.data.err,
        });
      } else {
        return res
          .status(500)
          .send({ message: "Error adding MostActive", error: err });
      }
    }
  };
  ...
  getMostActiveDAO = async (req: Request, res: Response) => {
    try {
      ...
      if (err.response) {
        return res.status(err.response.status).send({
          message: "Could not get Most Active DAO",
          error: err.response.data.err,
        });
      } else {
        return res.status(500).send({
          message: "Error getting Most Active DAO",
  ...
  getMostActiveContributor = async (req: Request, res: Response) => {
    try {
      ...
      if (err.response) {
        return res.status(err.response.status).send({
          message: "Could not get Most Active Contributor",
          error: err.response.data.err,
        });
      } else {
        return res.status(500).send({
          message: "Error getting Most Active Contributor",
          error: JSON.stringify(err),
        });
      }
    }
  ...
  addMostViewed = async (req: Request, res: Response) => {
    try {
      ...
      res
        .status(201)
        .json({ message: "MostViewed added successfully", data: result });
    } catch (err: any) {
      if (err.response) {
        return res.status(err.response.status).send({
          message: "Could not add MostViewed",
          error: err.response.data.err,
        });
      } else {
        return res
          .status(500)
          .send({ message: "Error adding MostViewed", error: err });
      }
    }
  };
  ...
  getMostViewedDAO = async (req: Request, res: Response) => {
    try {
      ...
      if (err.response) {
        return res.status(err.response.status).send({
          message: "Could not get Most Viewed DAO",
          error: err.response.data.err,
        });
      } else {
        return res.status(500).send({
          message: "Error getting Most Viewed DAO",
          error: JSON.stringify(err),
        });
      }
    }
  ...
  getMostViewedContributor = async (req: Request, res: Response) => {
    try {
      ...
      if (err.response) {
        return res.status(err.response.status).send({
          message: "Could not get Most Viewed Contributor",
          error: err.response.data.err,
        });
      } else {
        return res.status(500).send({
          message: "Error getting Most Viewed Contributor",
          error: JSON.stringify(err),
        });
      }
    }
